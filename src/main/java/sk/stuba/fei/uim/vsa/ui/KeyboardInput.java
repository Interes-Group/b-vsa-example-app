...
public class KeyboardInput {
    ...
    public static String PROMPT_DELIMETER = ":";

    protected static final String[] TRUE_INPUTS = {"y", "yes", "true", "1", "ano", "áno"};
    protected static final String[] FALSE_INPUTS = {"n", "no", "false", "0", "nie"};
